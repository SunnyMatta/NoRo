...
#define PBRF "Example/SHADERS/pbr.frag"
#define SKYBOXV "Example/SHADERS/skybox.vert"
#define SKYBOXF "Example/SHADERS/skybox.frag"
#define SHADOWV "Example/SHADERS/shadow.vert"
#define SHADOWF "Example/SHADERS/shadow.frag"
...
model SponzaScene = LoadMesh("Example/Sponza/Untitled.gltf");

unsigned int hdr = Load_HDRenv("Example/hdr.hdr");
